<template>
  <div class="flex flex-row justify-center items-center bg-info bg-center bg-cover px-60">
    <main
      class="flex flex-col lg:flex-row bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 rounded-xl overflow-hidden w-full shadow-lg m-4 lg:m-6"
    >
        ...
        <div class="grid grid-rows-4 grid-cols-1 gap-4 md:grid-rows-2 md:grid-cols-2">
          ...
          >
            ...
            <div class="text-white font-normal">
              Visual page, graphic pages, colors, button positions and interfaces Required
              skills are HTML ,CSS , JAVASCRIPT.
            </div>
          </div>
          <div
            class="rounded-2xl bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 p-4 flex flex-col relative undefined"
          >
            ...
            <div class="text-white font-normal">
              Writing the actual code for the site, as it controls everything that happens
          ...
          >
            ...
            <div class="text-white font-normal">
              He works on designing interfaces and writing code in the background. He has
              all the skills for both sides.
            </div>
          </div>
          <div
            class="rounded-2xl bg-white backdrop-filter backdrop-blur-lg bg-opacity-20 p-4 flex flex-col relative undefined"
          >
            ...
            <div class="text-white font-normal">
              It is the design of the website interface and all its contents before
              starting programming and development.
            </div>
          </div>
        </div>
      </div>
